					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="">
							...
							<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10"><input type="text" placeholder="Trading Name" name="name" class="form-control" value="{{ old('name',$agent->name) }}">
									@if ($errors->has('name'))
							...
							<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="email" class="form-control" placeholder="Email" name="email" value="{{ old('email',$agent->email) }}">
									@if ($errors->has('email'))
							...
							<div class="form-group {{ $errors->has('billing_email') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="Billing Email" name="billing_email" value="{{ old('billing_email',$agent->billing_email) }}">
							...
							<div class="form-group {{ $errors->has('abn') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10"><input type="text" placeholder="ABN/ACN" name="abn" class="form-control" value="{{ old('abn',$agent->abn) }}">
									@if ($errors->has('abn'))
							...
							<div class="form-group">
								<div{!! $errors->has('shipping_address') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<input id="shipping_address" type="text" placeholder="Shipping Address" name="shipping_address" class="form-control" value="{{ old('shipping_address', $agent->shipping_address) }}">
								...
								<div{!! $errors->has('billing_address') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<input id="billing_address" type="text" class="form-control" placeholder="Billing Address" name="billing_address" value="{{ old('billing_address', $agent->billing_address) }}">
							...
							<div class="form-group">
								<div{!! $errors->has('shipping_suburb') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<input id="shipping_suburb" type="text" placeholder="Shipping Suburb" name="shipping_suburb" class="form-control" value="{{ old('shipping_suburb', $agent->shipping_suburb) }}">
								...
								<div{!! $errors->has('billing_suburb') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<input id="billing_suburb" type="text" class="form-control" placeholder="Billing Suburb" name="billing_suburb" value="{{ old('billing_suburb', $agent->billing_suburb) }}">
									...
									<div class="col-lg-4">
										<select id="shipping_state" name="shipping_state" class="form-control">
											...
											@foreach (['ACT','NSW','NT','QLD','SA','TAS','VIC','WA'] as $state)
												<option value="{{ $state }}"{{ old('shipping_state', $agent->shipping_state) == $state ? ' selected' : '' }}>{{ $state }}</option>
											@endforeach
										</select>
								...
								<div{!! $errors->has('billing_state') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<select id="billing_state" name="billing_state" class="form-control">
											<option value=""></option>
											@foreach (['ACT','NSW','NT','QLD','SA','TAS','VIC','WA'] as $state)
												<option value="{{ $state }}"{{ old('billing_state', $agent->billing_state) == $state ? ' selected' : '' }}>{{ $state }}</option>
											@endforeach
										</select>
							...
							<div class="form-group">
								<div{!! $errors->has('shipping_postcode') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<input id="shipping_postcode" type="text" placeholder="Shipping Postcode" name="shipping_postcode" class="form-control" value="{{ old('shipping_postcode', $agent->shipping_postcode) }}">
								...
								<div{!! $errors->has('billing_postcode') ? ' class="has-error"' : '' !!}>
									...
									<div class="col-lg-4">
										<input id="billing_postcode" type="text" class="form-control" placeholder="Billing Postcode" name="billing_postcode" value="{{ old('billing_postcode', $agent->billing_postcode) }}">
							...
							<div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="input-phone form-control" placeholder="Phone" name="phone" value="{{ old('phone',$agent->phone) }}">
									@if ($errors->has('phone'))
							...
							<div class="form-group {{ $errors->has('mobile') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="input-mobile form-control" placeholder="Mobile" name="mobile" value="{{ old('mobile',$agent->mobile) }}">
							...
							<div class="form-group {{ $errors->has('fax') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="Fax" name="fax" value="{{ old('fax',$agent->fax) }}">
									@if ($errors->has('fax'))
							...
							<div class="form-group {{ $errors->has('bank_acc_name') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="Bank Account Name" name="bank_acc_name" value="{{ old('bank_acc_name',$agent->bank_acc_name) }}">
							...
							<div class="form-group {{ $errors->has('bank_acc_no') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="Bank Account Number" name="bank_acc_no" value="{{ old('bank_acc_no',$agent->bank_acc_no) }}">
							...
							<div class="form-group {{ $errors->has('bank_acc_bsb') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" placeholder="Bank BSB" name="bank_acc_bsb" value="{{ old('bank_acc_bsb',$agent->bank_acc_bsb) }}">
