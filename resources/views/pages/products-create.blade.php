					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="/products/create">
							...
							<div class="form-group {{ $errors->has('default_price') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<div class="input-group">
										...
										<input type="number" step="any" placeholder="00.00" name="default_price" class="form-control" value="{{ old('default_price') }}">
							...
							<div class="form-group {{ $errors->has('height_of_panel') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<div class="input-group">
										<input type="number" step="any" placeholder="Height Of Panel" name="height_of_panel" class="form-control" value="{{ old('height_of_panel') }}">
							...
							<div class="form-group {{ $errors->has('height_of_dust_supression') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<div class="input-group">
										<input type="number" step="any" class="form-control" placeholder="Height of dust panel" name="height_of_dust_supression" value="{{ old('height_of_dust_supression') }}">
										<span class="input-group-addon">meters</span>
									</div>
							...
							<div class="form-group {{ $errors->has('width') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<div class="input-group">
										<input type="number" step="any" placeholder="width" name="width" class="form-control" value="{{ old('width') }}">
										<span class="input-group-addon">meters</span>
									</div>
									@if ($errors->has('width'))
							...
							<div class="form-group {{ $errors->has('depth') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<div class="input-group">
										<input type="number" step="any" class="form-control" placeholder="Depth" name="depth" value="{{ old('depth') }}">
										<span class="input-group-addon">meters</span>
									</div>
									@if ($errors->has('depth'))
							...
							<div class="form-group {{ $errors->has('weight') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<div class="input-group">
										<input type="number" step="any" placeholder="Weight" name="weight" class="form-control" value="{{ old('weight') }}">
							...
							<div class="form-group {{ $errors->has('wind_rating') ? ' has-error' : '' }}">
								...
								<div class="col-lg-3">
									<input type="number" step="any" class="form-control" placeholder="Wind Rating" name="wind_rating" value="{{ old('wind_rating') }}">
