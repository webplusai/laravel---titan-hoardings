					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="">
							...
							<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" placeholder="Trading Name" name="name" class="form-control" value="{{ old('name') }}">
							...
							<div class="form-group {{ $errors->has('abn') ? ' has-error' : '' }}">
								...
								<div class="col-lg-10">
									<input type="text" placeholder="ABN/ACN" name="abn" class="form-control" value="{{ old('abn') }}">
									<span class="help-block"></span>
									@if ($errors->has('abn'))
